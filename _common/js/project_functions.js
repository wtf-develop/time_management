function isGoodResponse(json) {
    ...
    $('body').append(jth.render(json,'error_message'));
...
var isMobileDevice = null; //initiate as false
function isMobile() {
    if (isMobileDevice === undefined || isMobileDevice == null || ((typeof isMobileDevice) != 'boolean')) {
...
function showToastIfExists(json){
    ...
    $('body').append(jth.render(json,'toast_message'));
    $('#toast_modal').show();
    setTimeout(function(){
        $('#toast_modal').remove();
    }, 4000);
